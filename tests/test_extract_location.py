...
class MyTest(unittest.TestCase):
    ...
    def test_checkCapitalization(self):
        self.assertEqual(
            location_info_Google.extract_location("washington 98102")["Zipcode"], "98102"
        )
    ...
    def test_checkingTwoWordedStates(self):
        self.assertEqual(
            location_info_Google.extract_location("Washington DC 20022")["Zipcode"], "20022"
        )
        self.assertEqual(
            location_info_Google.extract_location("Princeton New Jersey 08540")["Zipcode"], "08540"
        )
