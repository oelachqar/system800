...
class MyTest(unittest.TestCase):
    def test_basic(self):
        self.assertDictEqual(
            date_info.extract_date_time(
                "april thirteen two thousand nineteen at four thirty PM"
            ),
    ...
    def test_AMPM(self):
        self.assertNotEqual(
            date_info.extract_date_time(
                "april thirteen two thousand nineteen at four thirty AM"
            ),
            date_info.extract_date_time(
                "april thirteen two thousand nineteen at four thirty PM"
            ),
    ...
    def test_spellings_of_AMPM(self):
        ...
        self.assertDictEqual(
            date_info.extract_date_time(
                "april thirteen two thousand nineteen at four thirty p.m."
            ),
            {"year": 2019, "month": 4, "day": 13, "hour": 16, "minute": 30},
        )
    ...
    def test_noMinutes(self):
        self.assertEqual(
            date_info.extract_date_time(
                "april thirteenth two thousand and sixteen at two PM"
            )["minute"],
            0,
        )
    ...
    def test_curveBallStreet(self):
        self.assertDictEqual(
            date_info.extract_date_time(
                "blah blah thirty one may st new york new york on april third,\
    ...
    def test_digits(self):
        self.assertDictEqual(
            date_info.extract_date_time("new york on april 3rd, 2017 at 1:30 PM "),
            {"year": 2017, "month": 4, "day": 3, "hour": 13, "minute": 30},
        )
    ...
    def test_returnsNoneWhenTranscriptionFailed(self):
        self.assertDictEqual(
            date_info.extract_date_time("on march 2021 at 4:30 pm"),
